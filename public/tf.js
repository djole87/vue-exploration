//import of needed base models
//import * as jsDeploymentModel from "../JsDeploymentModel.js";
...
export class TribefireJs {
  ...
  getSessionId() {
    return this.config.sessionIdProvider();
  }
...
export class GmSelectionListener {
  /**
   * tbd.
   * @param {GmContentView} support - tbd
   */
  onSelectionChanged(support) {}
}

export class GmContentView {
  /**
   * tbd.
   * @param {GmSelectionListener} listener - tbd
   */
  ...
  /**
   * tbd.
   * @returns {GmContentView} tbd
   */
  getView() {}
  getElement() {}
  select(element, keepExisting) {}
  getFirstSelectedIndex() {}
  deselectAll() {}
  configureGmSession(gmSession) {}
  getGmSession() {}
